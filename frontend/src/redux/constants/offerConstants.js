...
export const OFFER_CREATE_REVIEW_REQUEST = 'OFFER_CREATE_REVIEW_REQUEST'
export const OFFER_CREATE_REVIEW_SUCCESS = 'OFFER_CREATE_REVIEW_SUCCESS'
export const OFFER_CREATE_REVIEW_FAIL = 'OFFER_CREATE_REVIEW_FAIL'
export const OFFER_CREATE_REVIEW_RESET = 'OFFER_CREATE_REVIEW_RESET'